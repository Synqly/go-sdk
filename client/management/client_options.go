...
// ClientWithHeaderSynqlyIntegrator sets the synqlyIntegrator header on every request.
func ClientWithHeaderSynqlyIntegrator(synqlyIntegrator string) core.ClientOption {
	return func(opts *core.ClientOptions) {
		opts.SynqlyIntegrator = synqlyIntegrator
	}
}

// ClientWithHeaderSynqlyAccount sets the synqlyAccount header on every request.
func ClientWithHeaderSynqlyAccount(synqlyAccount string) core.ClientOption {
	return func(opts *core.ClientOptions) {
		opts.SynqlyAccount = synqlyAccount
	}
}

// ClientWithHeaderSynqlyIntegration sets the synqlyIntegration header on every request.
func ClientWithHeaderSynqlyIntegration(synqlyIntegration string) core.ClientOption {
	return func(opts *core.ClientOptions) {
		opts.SynqlyIntegration = synqlyIntegration
	}
}
