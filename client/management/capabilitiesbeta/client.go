...
func (c *Client) ListConnectors(
...
) (*management.BetaListConnectorCapabilitiesResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/v1beta/capabilities/connectors"
	...
	var response *management.BetaListConnectorCapabilitiesResponse
...
func (c *Client) ListProviders(
	ctx context.Context,
	opts ...option.RequestOption,
) (*management.BetaListProviderCapabilitiesResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/v1beta/capabilities/providers"
	...
	var response *management.BetaListProviderCapabilitiesResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
