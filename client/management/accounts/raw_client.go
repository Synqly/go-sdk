...
func (r *RawClient) List(
...
) (*core.Response[*management.ListAccountsResponse], error){
    ...
    return &core.Response[*management.ListAccountsResponse]{
...
func (r *RawClient) Get(
    ...
    opts ...option.RequestOption,
) (*core.Response[*management.GetAccountResponse], error){
    options := core.NewRequestOptions(opts...)
    baseURL := internal.ResolveBaseURL(
        options.BaseURL,
        r.baseURL,
    ...
    return &core.Response[*management.GetAccountResponse]{
        StatusCode: raw.StatusCode,
        Header: raw.Header,
        Body: response,
    }, nil
...
func (r *RawClient) Create(
    ...
    opts ...option.RequestOption,
) (*core.Response[*management.CreateAccountResponse], error){
    options := core.NewRequestOptions(opts...)
    baseURL := internal.ResolveBaseURL(
        options.BaseURL,
        r.baseURL,
    ...
    return &core.Response[*management.CreateAccountResponse]{
        StatusCode: raw.StatusCode,
        Header: raw.Header,
        Body: response,
    }, nil
...
func (r *RawClient) Update(
    ...
    opts ...option.RequestOption,
) (*core.Response[*management.UpdateAccountResponse], error){
    options := core.NewRequestOptions(opts...)
    baseURL := internal.ResolveBaseURL(
        options.BaseURL,
        r.baseURL,
    ...
    return &core.Response[*management.UpdateAccountResponse]{
        StatusCode: raw.StatusCode,
        Header: raw.Header,
        Body: response,
    }, nil
...
func (r *RawClient) Patch(
    ...
    opts ...option.RequestOption,
) (*core.Response[*management.PatchAccountResponse], error){
    options := core.NewRequestOptions(opts...)
    baseURL := internal.ResolveBaseURL(
        options.BaseURL,
        r.baseURL,
    ...
    return &core.Response[*management.PatchAccountResponse]{
        StatusCode: raw.StatusCode,
        Header: raw.Header,
        Body: response,
    }, nil
