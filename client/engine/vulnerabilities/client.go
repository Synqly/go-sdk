...
func (c *Client) GetScanStatus(
	...
	endpointURL := core.EncodeURL(baseURL+"/v1/vulnerabilities/scans/%v/status", scanId)
...
func (c *Client) QueryScanFindings(
	...
	endpointURL := core.EncodeURL(baseURL+"/v1/vulnerabilities/scans/%v/findings", scanId)
