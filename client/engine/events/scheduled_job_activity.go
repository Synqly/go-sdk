...
type ScheduledJobActivity struct {
	...
	ActivityId ScheduledJobActivityActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid ScheduledJobActivityCategoryUid `json:"category_uid,omitempty"`
	...
	DispositionId ScheduledJobActivityDispositionId `json:"disposition_id,omitempty"`
	...
	TypeUid ScheduledJobActivityTypeUid `json:"type_uid,omitempty"`
