...
type FileActivity struct {
	...
	ActivityId FileActivityActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid FileActivityCategoryUid `json:"category_uid,omitempty"`
	...
	DispositionId FileActivityDispositionId `json:"disposition_id,omitempty"`
	...
	TypeUid FileActivityTypeUid `json:"type_uid,omitempty"`
