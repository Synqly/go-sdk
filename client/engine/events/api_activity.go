...
type ApiActivity struct {
	...
	ActivityId ApiActivityActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid ApiActivityCategoryUid `json:"category_uid,omitempty"`
	...
	TypeUid ApiActivityTypeUid `json:"type_uid,omitempty"`
