...
type ModuleActivity struct {
	...
	ActivityId ModuleActivityActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid ModuleActivityCategoryUid `json:"category_uid,omitempty"`
	...
	DispositionId ModuleActivityDispositionId `json:"disposition_id,omitempty"`
	...
	TypeUid ModuleActivityTypeUid `json:"type_uid,omitempty"`
