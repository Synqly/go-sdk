...
type DnsActivity struct {
	...
	ActivityId DnsActivityActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid DnsActivityCategoryUid `json:"category_uid,omitempty"`
	...
	DispositionId DnsActivityDispositionId `json:"disposition_id,omitempty"`
	...
	RcodeId *DnsActivityRcodeId `json:"rcode_id,omitempty"`
	...
	TypeUid DnsActivityTypeUid `json:"type_uid,omitempty"`
