...
type AccountChange struct {
	...
	ActivityId AccountChangeActivityId `json:"activity_id,omitempty"`
	...
	CategoryUid AccountChangeCategoryUid `json:"category_uid,omitempty"`
	...
	TypeUid AccountChangeTypeUid `json:"type_uid,omitempty"`
