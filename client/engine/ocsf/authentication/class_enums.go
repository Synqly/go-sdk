...
// ServiceTicket. A Kerberos service ticket was requested.
const Activity_ServiceTicket ActivityId = 4
...
// Authentication_ServiceTicket. A Kerberos service ticket was requested.
const Type_Authentication_ServiceTicket TypeUid = 300204
