...
type EntityManagement struct {
	...
	Entity *ManagedEntity `json:"entity,omitempty"`
	// The updated managed entity.
	EntityResult *ManagedEntity `json:"entity_result,omitempty"`
...
type Device struct {
	...
	BootTime *Timestamp `json:"boot_time,omitempty"`
	// The time the system was booted.
...
type DigitalSignature struct {
	...
	StateId *DigitalSignatureStateId `json:"state_id,omitempty"`
}
...
type ManagedEntity struct {
	...
	TypeId *ManagedEntityTypeId `json:"type_id,omitempty"`
...
type User struct {
	...
	RiskLevel *string `json:"risk_level,omitempty"`
	// The normalized risk level id.
	RiskLevelId *UserRiskLevelId `json:"risk_level_id,omitempty"`
	// The risk score as reported by the event source.
	RiskScore *int `json:"risk_score,omitempty"`
