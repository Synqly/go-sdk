...
type GroupManagement struct {
	...
	Group *Group `json:"group" url:"group"`
...
func (g *GroupManagement) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		embed:       embed(*g),
		EndTimeDt:   core.NewOptionalDateTime(g.EndTimeDt),
		StartTimeDt: core.NewOptionalDateTime(g.StartTimeDt),
		TimeDt:      core.NewOptionalDateTime(g.TimeDt),
	}
