...
type CloudActivity struct {
	...
	Meeting *Meeting `json:"meeting,omitempty" url:"meeting,omitempty"`
	// The description of the event/finding, as defined by the source.
	Message *string `json:"message,omitempty" url:"message,omitempty"`
	// Information related to instant messaging, such as sending messages, adding users to channels, etc.
	Messaging *Messaging `json:"messaging,omitempty" url:"messaging,omitempty"`
	...
	Parameters *Object `json:"parameters,omitempty" url:"parameters,omitempty"`
	...
	SrcApp *Product `json:"src_app,omitempty" url:"src_app,omitempty"`
	...
	TargetApp *Product `json:"target_app,omitempty" url:"target_app,omitempty"`
	...
	WebResourcesResult []*WebResource `json:"web_resources_result,omitempty" url:"web_resources_result,omitempty"`
...
func (m *MeetingAttendee) UnmarshalJSON(data []byte) error {
	...
	var unmarshaler = struct {
		embed
		InvitedTimeDt *core.DateTime `json:"invited_time_dt,omitempty"`
	}{
		embed: embed(*m),
	}
	if err := json.Unmarshal(data, &unmarshaler); err != nil {
...
func (m *MeetingAttendee) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		embed:         embed(*m),
		InvitedTimeDt: core.NewOptionalDateTime(m.InvitedTimeDt),
	}
	return json.Marshal(marshaler)
}
