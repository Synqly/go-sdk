...
// DeviceSoftwareInfo. Device Software Info events report device software data that is either logged or proactively collected.
const Class_DeviceSoftwareInfo ClassUid = 5090
...
const Type_DeviceSoftwareInfo_Unknown TypeUid = 509000
// DeviceSoftwareInfo_Log. The discovered information is via a log.
const Type_DeviceSoftwareInfo_Log TypeUid = 509001
// DeviceSoftwareInfo_Collect. The discovered information is via a collection process.
const Type_DeviceSoftwareInfo_Collect TypeUid = 509002
// DeviceSoftwareInfo_Other
const Type_DeviceSoftwareInfo_Other TypeUid = 509099
