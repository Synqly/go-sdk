...
type SecurityFinding struct {
	...
	CisCsc []*CisCsc `json:"cis_csc,omitempty" url:"cis_csc,omitempty"`
	...
	Evidence interface{} `json:"evidence,omitempty" url:"evidence,omitempty"`
	// The Finding object provides details about a finding/detection generated by a security tool.
	Finding *Finding `json:"finding" url:"finding"`
...
type Finding struct {
	...
	SupportingData interface{} `json:"supporting_data,omitempty" url:"supporting_data,omitempty"`
