...
// Unknown. The injection type is unknown.
...
// QueueAPC
const InjectionType_QueueAPC InjectionTypeId = 3
// Other. The injection type is not mapped. See the <code>injection_type</code> attribute, which contains a data source specific value.
