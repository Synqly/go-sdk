...
// Clear. Clear the event log database, file, or cache.
const Activity_Clear ActivityId = 1
// Delete. Delete the event log database, file, or cache.
const Activity_Delete ActivityId = 2
// Export. Export the event log database, file, or cache.
const Activity_Export ActivityId = 3
// Archive. Archive the event log database, file, or cache.
const Activity_Archive ActivityId = 4
// Rotate. Rotate the event log database, file, or cache.
const Activity_Rotate ActivityId = 5
// Start. Start the event logging service.
const Activity_Start ActivityId = 6
// Stop. Stop the event logging service.
const Activity_Stop ActivityId = 7
// Restart. Restart the event logging service.
const Activity_Restart ActivityId = 8
// Enable. Enable the event logging service.
const Activity_Enable ActivityId = 9
// Disable. Disable the event logging service.
const Activity_Disable ActivityId = 10
...
// EventLogActivity. Event Log Activity events report actions pertaining to the system's event logging service(s), such as disabling logging or clearing the log data.
const Class_EventLogActivity ClassUid = 1008
...
// Unknown. The log type is unknown.
const LogType_Unknown LogTypeId = 0
// OS. The log type is an Operating System log.
const LogType_OS LogTypeId = 1
// Application. The log type is an Application log.
const LogType_Application LogTypeId = 2
// Other. The log type is not mapped. See the <code>log_type</code> attribute, which contains a data source specific value.
const LogType_Other LogTypeId = 99
...
// EventLogActivity_Unknown
const Type_EventLogActivity_Unknown TypeUid = 100800
// EventLogActivity_Clear. Clear the event log database, file, or cache.
const Type_EventLogActivity_Clear TypeUid = 100801
// EventLogActivity_Delete. Delete the event log database, file, or cache.
const Type_EventLogActivity_Delete TypeUid = 100802
// EventLogActivity_Export. Export the event log database, file, or cache.
const Type_EventLogActivity_Export TypeUid = 100803
// EventLogActivity_Archive. Archive the event log database, file, or cache.
const Type_EventLogActivity_Archive TypeUid = 100804
// EventLogActivity_Rotate. Rotate the event log database, file, or cache.
const Type_EventLogActivity_Rotate TypeUid = 100805
// EventLogActivity_Start. Start the event logging service.
const Type_EventLogActivity_Start TypeUid = 100806
// EventLogActivity_Stop. Stop the event logging service.
const Type_EventLogActivity_Stop TypeUid = 100807
// EventLogActivity_Restart. Restart the event logging service.
const Type_EventLogActivity_Restart TypeUid = 100808
// EventLogActivity_Enable. Enable the event logging service.
const Type_EventLogActivity_Enable TypeUid = 100809
// EventLogActivity_Disable. Disable the event logging service.
const Type_EventLogActivity_Disable TypeUid = 100810
// EventLogActivity_Other
const Type_EventLogActivity_Other TypeUid = 100899
