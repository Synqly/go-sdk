...
// Create. A new Data Security finding is created.
const Activity_Create ActivityId = 1
// Update. An existing Data Security finding is updated with more information.
const Activity_Update ActivityId = 2
// Close. An existing Data Security finding is closed, this can be due to any resolution (e.g., True Positive, False Positive, etc.).
const Activity_Close ActivityId = 3
// Suppressed. An existing Data Security finding is suppressed due to inaccurate detection techniques or a known true negative.
const Activity_Suppressed ActivityId = 4
...
// DataSecurityFinding_Unknown
const Type_DataSecurityFinding_Unknown TypeUid = 200600
// DataSecurityFinding_Create. A new Data Security finding is created.
const Type_DataSecurityFinding_Create TypeUid = 200601
// DataSecurityFinding_Update. An existing Data Security finding is updated with more information.
const Type_DataSecurityFinding_Update TypeUid = 200602
// DataSecurityFinding_Close. An existing Data Security finding is closed, this can be due to any resolution (e.g., True Positive, False Positive, etc.).
const Type_DataSecurityFinding_Close TypeUid = 200603
// DataSecurityFinding_Suppressed. An existing Data Security finding is suppressed due to inaccurate detection techniques or a known true negative.
const Type_DataSecurityFinding_Suppressed TypeUid = 200604
// DataSecurityFinding_Other
const Type_DataSecurityFinding_Other TypeUid = 200699
