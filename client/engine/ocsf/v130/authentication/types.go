...
type Authentication struct {
	...
	AuthProtocolId *AuthProtocolId `json:"auth_protocol_id,omitempty"`
	...
	LogonTypeId *LogonTypeId `json:"logon_type_id,omitempty"`
...
type AuthFactor struct {
	...
	FactorTypeId AuthFactorFactorTypeId `json:"factor_type_id"`
