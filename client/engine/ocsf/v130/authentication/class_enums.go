...
// Preauth. A preauthentication stage was engaged.
const Activity_Preauth ActivityId = 6
...
// Unknown. The logon type is unknown.
const LogonType_Unknown LogonTypeId = 0
// System. Used only by the System account, for example at system startup.
const LogonType_System LogonTypeId = 1
...
// Authentication_Preauth. A preauthentication stage was engaged.
const Type_Authentication_Preauth TypeUid = 300206
