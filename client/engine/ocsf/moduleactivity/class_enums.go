...
// Load
const Activity_Load ActivityId = 1
// Unload
const Activity_Unload ActivityId = 2
...
// ModuleActivity. Module  Activity events report when a process loads or unloads the <code>module</code>.
const Class_ModuleActivity ClassUid = 1005
...
const Type_ModuleActivity_Unknown TypeUid = 100500
// ModuleActivity_Load
const Type_ModuleActivity_Load TypeUid = 100501
// ModuleActivity_Unload
const Type_ModuleActivity_Unload TypeUid = 100502
// ModuleActivity_Other
const Type_ModuleActivity_Other TypeUid = 100599
