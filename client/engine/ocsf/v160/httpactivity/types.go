...
type HttpActivity struct {
	...
	HttpCookies []*HttpCookie `json:"http_cookies,omitempty" url:"http_cookies,omitempty"`
...
func (h *HttpActivity) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		embed:       embed(*h),
		EndTimeDt:   core.NewOptionalDateTime(h.EndTimeDt),
		StartTimeDt: core.NewOptionalDateTime(h.StartTimeDt),
		TimeDt:      core.NewOptionalDateTime(h.TimeDt),
	}
...
func (h *HttpCookie) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		embed:            embed(*h),
		ExpirationTimeDt: core.NewOptionalDateTime(h.ExpirationTimeDt),
	}
	return json.Marshal(marshaler)
}
...
type NetworkTraffic struct {
	...
	BytesMissed *int `json:"bytes_missed,omitempty" url:"bytes_missed,omitempty"`
