...
// AccessCheck. Access check for a file. The <code>security_control</code> profile can be used to add the access check results.
const Activity_AccessCheck ActivityId = 17
...
// FileHostingActivity. File Hosting Activity events report the actions taken by file management applications, including file sharing servers like Sharepoint and services such as Box, MS OneDrive, Google Drive, or network file share services.
...
// Unknown. The share type is unknown.
const ShareType_Unknown ShareTypeId = 0
// File
const ShareType_File ShareTypeId = 1
// Pipe
const ShareType_Pipe ShareTypeId = 2
// Print
const ShareType_Print ShareTypeId = 3
// Other. The share type is not mapped. See the <code>share_type</code> attribute, which contains a data source specific value.
const ShareType_Other ShareTypeId = 99
...
// FileHostingActivity_AccessCheck. Access check for a file. The <code>security_control</code> profile can be used to add the access check results.
const Type_FileHostingActivity_AccessCheck TypeUid = 600617
