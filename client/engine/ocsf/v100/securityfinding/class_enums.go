...
// Create. A security finding is created.
const Activity_Create ActivityId = 1
// Update. A security finding is updated.
...
// Other. The detection impact is not mapped. See the <code>impact</code> attribute, which contains a data source specific value.
...
// SecurityFinding_Create. A security finding is created.
const Type_SecurityFinding_Create TypeUid = 200101
// SecurityFinding_Update. A security finding is updated.
