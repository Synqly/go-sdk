...
// DeviceConfigState. Device Config State events report device configuration data and CIS Benchmark results.
const Class_DeviceConfigState ClassUid = 5002
...
// DeviceConfigState_Unknown
const Type_DeviceConfigState_Unknown TypeUid = 500200
// DeviceConfigState_Log. The discovered information is via a log.
const Type_DeviceConfigState_Log TypeUid = 500201
// DeviceConfigState_Collect. The discovered information is via a collection process.
const Type_DeviceConfigState_Collect TypeUid = 500202
// DeviceConfigState_Other
const Type_DeviceConfigState_Other TypeUid = 500299
