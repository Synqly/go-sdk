...
type ProcessActivity struct {
	...
	Module *Module `json:"module,omitempty" url:"module,omitempty"`
...
func (p *ProcessActivity) MarshalJSON() ([]byte, error) {
	...
	var marshaler = struct {
		...
		embed:       embed(*p),
		EndTimeDt:   core.NewOptionalDateTime(p.EndTimeDt),
		StartTimeDt: core.NewOptionalDateTime(p.StartTimeDt),
		TimeDt:      core.NewOptionalDateTime(p.TimeDt),
	}
