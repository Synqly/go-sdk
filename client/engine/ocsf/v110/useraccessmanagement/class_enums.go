...
// AssignPrivileges. Assign privileges to a user.
const Activity_AssignPrivileges ActivityId = 1
// RevokePrivileges. Revoke privileges from a user.
...
// UserAccessManagement. User Access Management events report management updates to a user's privileges.
const Class_UserAccessManagement ClassUid = 3005
...
// UserAccessManagement_Unknown
const Type_UserAccessManagement_Unknown TypeUid = 300500
// UserAccessManagement_AssignPrivileges. Assign privileges to a user.
const Type_UserAccessManagement_AssignPrivileges TypeUid = 300501
// UserAccessManagement_RevokePrivileges. Revoke privileges from a user.
const Type_UserAccessManagement_RevokePrivileges TypeUid = 300502
// UserAccessManagement_Other
const Type_UserAccessManagement_Other TypeUid = 300599
