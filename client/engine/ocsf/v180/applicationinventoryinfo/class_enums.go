...
// ApplicationInventoryInfo. Application Inventory Info events report application inventory information that is either logged or proactively collected. For example, when collecting application information from a CMDB, running a network sweep of connected applications, or when scanning an application with a application security tool.
const Class_ApplicationInventoryInfo ClassUid = 98905001

// RiskLevelId Values
// Risk Level ID. This field is deprecated and will be removed in a future sdk version. Use the application.risk_level_id attribute instead.
...
// ApplicationInventoryInfo_Unknown
const Type_ApplicationInventoryInfo_Unknown TypeUid = 9890500100
// ApplicationInventoryInfo_Log. The discovered information is via a log.
const Type_ApplicationInventoryInfo_Log TypeUid = 9890500101
// ApplicationInventoryInfo_Collect. The discovered information is via a collection process.
const Type_ApplicationInventoryInfo_Collect TypeUid = 9890500102
// ApplicationInventoryInfo_Other
const Type_ApplicationInventoryInfo_Other TypeUid = 9890500199
