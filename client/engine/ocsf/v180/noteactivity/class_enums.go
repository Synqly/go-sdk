...
// NoteActivity. Note Activity events report notes created on threats.
const Class_NoteActivity ClassUid = 98902001
...
// Deleted. The Finding was deleted. For example, it might have been created in error.
const Status_Deleted StatusId = 6
...
// NoteActivity_Unknown
const Type_NoteActivity_Unknown TypeUid = 9890200100
// NoteActivity_Create. A finding was created.
const Type_NoteActivity_Create TypeUid = 9890200101
// NoteActivity_Update. A finding was updated.
const Type_NoteActivity_Update TypeUid = 9890200102
// NoteActivity_Close. A finding was closed.
const Type_NoteActivity_Close TypeUid = 9890200103
// NoteActivity_Other
const Type_NoteActivity_Other TypeUid = 9890200199
