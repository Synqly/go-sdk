...
// ComplianceControlInventoryInfo. Compliance Control Inventory Info events report the compliance controls defined in a GRC platform, along with their framework mappings and current status. For example, when listing the controls tracked in a compliance-automation tool.
const Class_ComplianceControlInventoryInfo ClassUid = 98905004
...
// ComplianceControlInventoryInfo_Unknown
const Type_ComplianceControlInventoryInfo_Unknown TypeUid = 9890500400
// ComplianceControlInventoryInfo_Log. The discovered information is via a log.
const Type_ComplianceControlInventoryInfo_Log TypeUid = 9890500401
// ComplianceControlInventoryInfo_Collect. The discovered information is via a collection process.
const Type_ComplianceControlInventoryInfo_Collect TypeUid = 9890500402
// ComplianceControlInventoryInfo_Other
const Type_ComplianceControlInventoryInfo_Other TypeUid = 9890500499
