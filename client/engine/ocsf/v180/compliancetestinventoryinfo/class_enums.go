...
// ComplianceTestInventoryInfo. Compliance Test Inventory Info events report the automated tests defined in a GRC platform, along with their current pass/fail status and the controls they validate. For example, when listing the tests in a compliance-automation tool.
const Class_ComplianceTestInventoryInfo ClassUid = 98905007
...
// ComplianceTestInventoryInfo_Unknown
const Type_ComplianceTestInventoryInfo_Unknown TypeUid = 9890500700
// ComplianceTestInventoryInfo_Log. The discovered information is via a log.
const Type_ComplianceTestInventoryInfo_Log TypeUid = 9890500701
// ComplianceTestInventoryInfo_Collect. The discovered information is via a collection process.
const Type_ComplianceTestInventoryInfo_Collect TypeUid = 9890500702
// ComplianceTestInventoryInfo_Other
const Type_ComplianceTestInventoryInfo_Other TypeUid = 9890500799
