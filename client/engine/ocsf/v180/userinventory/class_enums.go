...
// UserInventoryInfo. User Inventory Info events report user inventory data that is either logged or proactively collected. For example, when collecting user information from Active Directory entries.
const Class_UserInventoryInfo ClassUid = 5003
...
// UserInventoryInfo_Unknown
const Type_UserInventoryInfo_Unknown TypeUid = 500300
// UserInventoryInfo_Log. The discovered information is via a log.
const Type_UserInventoryInfo_Log TypeUid = 500301
// UserInventoryInfo_Collect. The discovered information is via a collection process.
const Type_UserInventoryInfo_Collect TypeUid = 500302
// UserInventoryInfo_Other
const Type_UserInventoryInfo_Other TypeUid = 500399
