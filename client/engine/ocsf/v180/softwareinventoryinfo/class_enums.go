...
// SoftwareInventoryInfo. Software Inventory Info events report device software inventory data that is either logged or proactively collected. For example, when collecting device information from a CMDB or running a network sweep of connected devices.
const Class_SoftwareInventoryInfo ClassUid = 5020
...
// SoftwareInventoryInfo_Unknown
const Type_SoftwareInventoryInfo_Unknown TypeUid = 502000
// SoftwareInventoryInfo_Log. The discovered information is via a log.
const Type_SoftwareInventoryInfo_Log TypeUid = 502001
// SoftwareInventoryInfo_Collect. The discovered information is via a collection process.
const Type_SoftwareInventoryInfo_Collect TypeUid = 502002
// SoftwareInventoryInfo_Other
const Type_SoftwareInventoryInfo_Other TypeUid = 502099
