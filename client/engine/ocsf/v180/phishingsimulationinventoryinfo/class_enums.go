...
// PhishingSimulationInventoryInfo_Unknown
const Type_PhishingSimulationInventoryInfo_Unknown TypeUid = 9890500300
// PhishingSimulationInventoryInfo_Log. The discovered information is via a log.
const Type_PhishingSimulationInventoryInfo_Log TypeUid = 9890500301
// PhishingSimulationInventoryInfo_Collect. The discovered information is via a collection process.
const Type_PhishingSimulationInventoryInfo_Collect TypeUid = 9890500302
// PhishingSimulationInventoryInfo_Other
const Type_PhishingSimulationInventoryInfo_Other TypeUid = 9890500399
