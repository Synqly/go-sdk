...
// ComplianceEvidenceInventoryInfo. Compliance Evidence Inventory Info events report the documentation artifacts collected in a GRC platform to prove controls are working, along with the controls or tests they support. For example, when listing the evidence attached to tests in a compliance-automation tool.
const Class_ComplianceEvidenceInventoryInfo ClassUid = 98905006
...
// ComplianceEvidenceInventoryInfo_Unknown
const Type_ComplianceEvidenceInventoryInfo_Unknown TypeUid = 9890500600
// ComplianceEvidenceInventoryInfo_Log. The discovered information is via a log.
const Type_ComplianceEvidenceInventoryInfo_Log TypeUid = 9890500601
// ComplianceEvidenceInventoryInfo_Collect. The discovered information is via a collection process.
const Type_ComplianceEvidenceInventoryInfo_Collect TypeUid = 9890500602
// ComplianceEvidenceInventoryInfo_Other
const Type_ComplianceEvidenceInventoryInfo_Other TypeUid = 9890500699
