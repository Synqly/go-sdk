...
// OSINTInventoryInfo_Unknown
const Type_OSINTInventoryInfo_Unknown TypeUid = 502100
// OSINTInventoryInfo_Log. The discovered information is via a log.
const Type_OSINTInventoryInfo_Log TypeUid = 502101
// OSINTInventoryInfo_Collect. The discovered information is via a collection process.
const Type_OSINTInventoryInfo_Collect TypeUid = 502102
// OSINTInventoryInfo_Other
const Type_OSINTInventoryInfo_Other TypeUid = 502199
