...
// ComplianceFrameworkInventoryInfo. Compliance Framework Inventory Info events report the compliance standards and regulatory frameworks an organization is tracking in a GRC platform, along with aggregate posture counts. For example, when listing the frameworks in scope in a compliance-automation tool.
const Class_ComplianceFrameworkInventoryInfo ClassUid = 98905005
...
// ComplianceFrameworkInventoryInfo_Unknown
const Type_ComplianceFrameworkInventoryInfo_Unknown TypeUid = 9890500500
// ComplianceFrameworkInventoryInfo_Log. The discovered information is via a log.
const Type_ComplianceFrameworkInventoryInfo_Log TypeUid = 9890500501
// ComplianceFrameworkInventoryInfo_Collect. The discovered information is via a collection process.
const Type_ComplianceFrameworkInventoryInfo_Collect TypeUid = 9890500502
// ComplianceFrameworkInventoryInfo_Other
const Type_ComplianceFrameworkInventoryInfo_Other TypeUid = 9890500599
