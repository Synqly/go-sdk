...
// TrainingCampaignInventoryInfo. Training Campaign Inventory Info events report security awareness training campaign inventory from security awareness training products. These events describe training campaigns, assignments, or learning program instances that are either logged or proactively collected.
const Class_TrainingCampaignInventoryInfo ClassUid = 98905002
...
// TrainingCampaignInventoryInfo_Unknown
const Type_TrainingCampaignInventoryInfo_Unknown TypeUid = 9890500200
// TrainingCampaignInventoryInfo_Log. The discovered information is via a log.
const Type_TrainingCampaignInventoryInfo_Log TypeUid = 9890500201
// TrainingCampaignInventoryInfo_Collect. The discovered information is via a collection process.
const Type_TrainingCampaignInventoryInfo_Collect TypeUid = 9890500202
// TrainingCampaignInventoryInfo_Other
const Type_TrainingCampaignInventoryInfo_Other TypeUid = 9890500299
